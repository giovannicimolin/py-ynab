# YNAB API Python Client [![Build Status](https://travis-ci.org/giovannicimolin/python-ynab-client.svg?branch=master)](https://travis-ci.org/giovannicimolin/python-ynab-client)
