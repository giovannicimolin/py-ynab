...
class HybridTransaction(object):
    ...
    def __init__(self, id=None, _date=None, amount=None, memo=None, cleared=None, approved=None, flag_color=None, account_id=None, payee_id=None, category_id=None, transfer_account_id=None, transfer_transaction_id=None, matched_transaction_id=None, import_id=None, deleted=None, type=None, parent_transaction_id=None, account_name=None, payee_name=None, category_name=None):  # noqa: E501
