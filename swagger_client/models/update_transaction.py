...
class UpdateTransaction(object):
    ...
    def __init__(self, account_id=None, _date=None, amount=None, payee_id=None, payee_name=None, category_id=None, memo=None, cleared=None, approved=None, flag_color=None, import_id=None, id=None):  # noqa: E501
